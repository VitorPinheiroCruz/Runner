...
def display_score():
    ...
    score_surf = test_font.render(f'Score: {current_time / 1000:.2f}', False, (111, 196, 169))
...
ground_surface = pygame.transform.scale(ground_surface, (1000, 168))
...
ground_timer = pygame.USEREVENT + 2
pygame.time.set_timer(ground_timer, 100)
...
while True:
    for event in pygame.event.get():
        if event.type == pygame.QUIT:
            ...
            # After game over, restart the game pressing space
